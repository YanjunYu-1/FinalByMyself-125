    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfilesUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfilesUser_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfilesUser_Profile_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    TicketTypeId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TicketPriorityId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TicketStatusId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Ticket_Profile_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Profile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfilesUser_ProjectId",
                table: "ProfilesUser",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfilesUser_UserId",
                table: "ProfilesUser",
                column: "UserId");
